...
export default memo(function WXHAppFooter() {
  return (
  <AppFooterWrapper>
    <div className="wrap-v2 content">
      <FooterLeft className="left">
            ...
            footerLinks.map((item,index) => {
              return (
                <Fragment key={item.title}>
                  ...
                  <span className="line">{footerLinks.length-1 === index? null:<span>|</span>}</span>
                </Fragment>
              )
            })
          }
        ...
        <div className="info">
          ...
          <span><span className="gongan"></span><a target="_blank" rel="noreferrer" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010902002564">浙公网安备 33010902002564号</a></span>
        </div>
      </FooterLeft>
